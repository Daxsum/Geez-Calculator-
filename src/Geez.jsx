...
import './index.css';
import {GeezNumber,Calculator} from './geez-number';
...
<img className='img' src='/image/logo.png' alt="logo" width="300 px" height="200px"/>
...
<div id='GeezCalculator' className='badge rectangle-pill bg-Secondary'>
        ...
        <div className='navBar'>
            ...
            <button onClick={reset} id="AC" className='Abadge rounded-pill bg-danger'>አንጻ</button>
  ...
  <div className="container-fluidd">
    <span className="navbar-text">
      All write reserved |&copy; created by kal dax ,2014
    </span>
  </div>
</nav>
</div>
